...
const formTexts = {
  it: {
    ...
    privateCompany: "Azienda privata",
    ...
    interestPlaceholder: "Es: gestione ticket, reclami, customer care, formazione guidata, supporto operatori...",
  ...
  en: {
    ...
    interestPlaceholder: "E.g. ticket management, claims, customer care, guided training, operator support...",
  ...
  fr: {
    ...
    interestPlaceholder: "Ex. gestion des tickets, réclamations, service client, formation guidée, support aux opérateurs...",
  ...
  de: {
    ...
    agency: "Behörde",
    privateCompany: "Privatunternehmen",
    ...
    interestPlaceholder: "Z. B. Ticketmanagement, Beschwerden, Kundenservice, geführte Schulungen, Operator-Support...",
  ...
  es: {
    ...
    interestPlaceholder: "Ej.: gestión de tickets, reclamaciones, atención al cliente, formación guiada, soporte a operadores...",
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.tipologiaEnte} onValueChange={(value) => handleSelectChange("tipologiaEnte", value)}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="azienda_privata">{text.privateCompany}</SelectItem>
