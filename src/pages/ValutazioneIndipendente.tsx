...
const copy = {
  it: {
    ...
    noteTitle: "Origine dell’analisi",
    noteText: "Questa analisi è stata generata attraverso Google Antigravity a seguito dell’esame della documentazione tecnica e architetturale di CAELO e del confronto con le principali categorie di piattaforme AI enterprise. La valutazione è stata prodotta dall’agente sulla base dei materiali sottoposti all’analisi e non costituisce una certificazione, un audit formale o una graduatoria ufficiale di mercato.",
  ...
  en: {
    ...
    noteTitle: "Origin of the analysis",
    noteText: "This analysis was generated through Google Antigravity following an examination of CAELO’s technical and architectural documentation and a comparison with the main categories of enterprise AI platforms. The assessment was produced by the agent on the basis of the materials submitted for analysis and does not constitute a certification, a formal audit or an official market ranking.",
    market: "Positioning",
  ...
  fr: {
    ...
    noteTitle: "Origine de l’analyse",
    noteText: "Cette analyse a été générée au moyen de Google Antigravity après examen de la documentation technique et architecturale de CAELO et comparaison avec les principales catégories de plateformes d’IA enterprise. L’évaluation a été produite par l’agent sur la base des documents soumis à l’analyse et ne constitue ni une certification, ni un audit formel, ni un classement officiel du marché.",
